    ...
    <>
      <div className="header    relative  md:px-5  lg:px-12 xl:px-24">
        ...
        <div className="flex flex-col r  bg-white lg:block rounded-lg  text-white   ">
          ...
          <div className=" px-4 border-b-2 shadow-sm     space-y-1 py-1 ">
            ...
            <div className="tabs FromDateDeapt grid grid-cols-1 gap-5 xl:grid-cols-2 xl:gap-3">
              <div className="grid relative gap-5 md:grid-cols-2">
                <div className="1stInput relative rounded gap-3 h-[3.5rem]  flex items-center px-3  border border-slate-400 text-black">
                  ...
                  {toogleBtnn ? fromCityCompo() : AnyWhereCompo()}
                </div>
                <div
                ...
                <div className="2ndtInput relative rounded gap-3  h-[3.5rem] flex items-center px-3  border border-slate-400 text-black">
                  <IoLocationSharp className="text-xl" />
                  ...
                  {toogleBtnn ?  AnyWhereCompo() : fromCityCompo()}
                </div>
              </div>
              <div className="grid grid-cols-1 gap-2 md:grid-cols-4">
                <div className="flex items-center h-[3.5rem] gap-2 px-3 py-2 border-2 text-black border-slate-200  rounded-md">
          ...
          <div className="flex  bottomDropDown justify-start    xl:justify-end">
